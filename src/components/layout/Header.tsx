            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-16">
                    ...
                    <div className="flex-shrink-0 flex items-center">
                        <Link href="/" className="text-xl font-bold tracking-tight text-primary-gradient">
                            스냅투스토리
                        </Link>
                    </div>
                    ...
                    <nav className="hidden md:flex space-x-8">
                        <Link href="#ai-story" className="text-sm font-medium text-gray-500 hover:text-primary transition-colors">
                            AI 스토리 생성
                        </Link>
                        <Link href="#gallery" className="text-sm font-medium text-gray-500 hover:text-primary transition-colors">
                            내 갤러리
                        </Link>
                        <Link href="#pricing" className="text-sm font-medium text-gray-500 hover:text-primary transition-colors">
                            요금제
                        </Link>
                        <Link href="#history" className="text-sm font-medium text-gray-500 hover:text-primary transition-colors">
                            사용내역
                        </Link>
                    </nav>
                    ...
                    <div className="hidden md:flex items-center">
                        <button className="inline-flex items-center px-5 py-2 border border-transparent text-sm font-medium rounded-full shadow-lg shadow-primary/20 text-white bg-primary-gradient hover:opacity-90 transition-all active:scale-95">
                            시작하기
                        </button>
                    </div>
